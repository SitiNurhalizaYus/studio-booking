...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-semibold text-gray-800">Tambah Booking Baru</h1>
        <p class="text-sm text-gray-500">Lengkapi form untuk membuat booking</p>
    </div>
...
<div class="bg-white rounded-2xl shadow-sm p-8 space-y-8">
    ...
    <div>
        ...
        {{-- SLOT --}}
        <div class="mt-5">
            <label class="block text-sm font-medium mb-2">Pilih Jam</label>
